...
class ThreeLayerDenseRelu(keras.Model):

    def __init__(self):
        super(ThreeLayerDenseRelu,self).__init__()
        self.layer1=layers.Dense(200,activation=tf.nn.relu)
        self.layer2=layers.Dense(200,activation=tf.nn.relu)
        self.layerOut=layers.Dense(10)
